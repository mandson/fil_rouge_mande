				...
				<div class="container">
					...
					<div class="collapse navbar-collapse offset" id="navbarSupportedContent">
						...
						<ul class="nav navbar-nav menu_nav ml-auto">
						    <li class="nav-item  {{ Request::is('accueil*','/') ? 'active' : '' }} "><a class="nav-link ftk_font_menu ftk_espace " href="accueil">ACCUEIL</a></li>
							...
							<li class="nav-item {{ Request::is('products*') ? 'active' : '' }}"><a class="nav-link ftk_font_menu" href="#">OEIL DU CAMPUS</a> <span class="lnr lnr-eye"></span></li>
					...
					<div>	<a class="navbar-brand logo_h " href="#"><img class="ftk_logo1" src="users/img/ftk-img/iDmages.jpg" alt=""></a></div>
					...
					<div class="owl-thumbs d-flex justify-content-center" data-slider-id="1">
						<div class="owl-thumb-item">
							<div class="position-relative">
								<img class="img-fluid" src="{{asset('users/img/testimonial/t1.jpg')}}" alt="">
							</div>
							<div class="overlay-grad"></div>
						</div>
						<div class="owl-thumb-item">
							<div class="position-relative">
								<img class="img-fluid" src="{{asset('users/img/testimonial/t2.jpg')}}" alt="">
							</div>
							<div class="overlay-grad"></div>
						</div>
						<div class="owl-thumb-item">
							<div class="position-relative">
								<img class="img-fluid" src="{{asset('users/img/testimonial/t3.jpg')}}" alt="">
							</div>
							<div class="overlay-grad"></div>
						</div>
						<div class="owl-thumb-item">
							<div class="position-relative">
								<img class="img-fluid" src="{{asset('users/img/testimonial/t4.jpg')}}" alt="">
							</div>
							<div class="overlay-grad"></div>
						</div>
					</div>
