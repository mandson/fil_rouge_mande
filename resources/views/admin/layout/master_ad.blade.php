...
<body>
  ...
  <section id="container" class="">
    ...
    <header class="header dark-bg">
      ...
      <!--logo start-->
      <a href="index.html" class="logo">IRISPROGRAMME <span class="lite">Admin</span></a>
      <!--logo end-->
        ...
        <ul class="sidebar-menu">
          ...
          <li class="sub-menu">
            ...
            <ul class="sub">
              ...
              <li><a class="" href="f-validation">Urgent/Communique</a></li>
            </ul>
          </li>
          <li class="sub-menu">
            <a href="javascript:;" class="">
            ...
            <ul class="sub">
              <li><a class="" href="f-element">Form Elements</a></li>
              <li><a class="" href="f-validation">Form Validation</a></li>
            </ul>
          </li>
          <li class="sub-menu">
            <a href="javascript:;" class="">
